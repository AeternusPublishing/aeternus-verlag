// Using CommonJS format to perfectly match your .eleventy.js file
module.exports = {

  "meta.title": {
    de: "AETERNUS VERLAG · Editionshaus für historische Texte & Klassiker",
    en: "AETERNUS VERLAG · Publisher for Historical Texts & Classics"
  },
  "meta.description": {
    de: "Ein unabhängiges Editionshaus für Werke mit Bestand. Wiedererschließung älterer Texte über Natur, Wildnis, Staatskunst & Zivilisation für heutige Leser.",
    en: "An independent editorial house for works of endurance. Recovering older texts on nature, wilderness, statecraft & civilization for modern readers."
  },
  // Navigation & Actions
 "nav.mission": { "de": "Leitbild", "en": "Mission" },
  "nav.translation": { "de": "Übersetzung", "en": "Translation" }, // Fixed trailing space after Translation
  "nav.seton": { "de": "Die Seton-Edition", "en": "The Seton Edition" },
  ...
  "about.text1": { 
    de: "AETERNUS VERLAG ist ein unabhängiges Editionshaus für Werke, die nicht nach kurzer Aufmerksamkeit verlangen, sondern nach Bestand. Unser Programm gilt Texten, die aus der Tiefe der Geschichte sprechen: Naturbeobachtung, Wildnis, Grenzerfahrung, Krieg, Unternehmertum, Staatskunst, Architektur, Charakterbildung und Zivilisation.", 
  ...
  "translation.title": { 
    de: "Alte Texte wieder lesbar machen.", 
  ...
  "translation.promise": { 
    de: "AETERNUS macht alte Texte nicht jünger. AETERNUS macht sie wieder zugänglich.", 
    en: "AETERNUS does not make old texts younger. AETERNUS makes them accessible again." 
  },
  "translation.button": { 
    de: "Unsere Editionsgrundsätze lesen.", 
...
,
  ...
  // CTAs
  "hunted.btnExplore": {
    de: "Mehr zur Seton-Edition",
    en: "Explore the Seton Edition"
  },
  "hunted.btnSample": {
    de: "Leseprobe folgt",
    en: "Reading Sample Coming Soon"
  },
...
"catalogue.eyebrow": {
  ...
  "catalogue.title": {
    de: "Der Katalog im Aufbau.",
    en: "A catalogue in formation."
  },
  "catalogue.intro1": {
    de: "Der Katalog von AETERNUS VERLAG wächst aus wenigen sorgfältig gewählten Linien. Am Anfang steht Ernest Thompson Seton: ein Autor, dessen Werk Naturbeobachtung, Erzählkunst und moralische Schärfe verbindet. Weitere Reihen folgen aus den Bereichen Grenzliteratur, Strategie, Geschichte, Unternehmertum und Zivilisation.",
    en: "The catalogue of AETERNUS VERLAG grows from a small number of carefully chosen lines. It begins with Ernest Thompson Seton: an author whose work unites natural observation, narrative power, and moral clarity. Further series will follow in the fields of frontier literature, strategy, history, enterprise, and civilization."
  },
  "catalogue.intro2": {
    de: "Jeder Titel wird nicht nur übertragen, sondern editorisch erschlossen. Die deutsche Fassung ist dabei keine beiläufige Ausgabe, sondern die führende Textgestalt: geprüft, sprachlich eingerichtet, syntaktisch geordnet und auf dauerhafte Lesbarkeit hin bearbeitet.",
    en: "Each title is not merely translated, but editorially recovered. The German edition is not a secondary version, but the leading textual form: examined, linguistically prepared, syntactically ordered, and shaped for lasting readability."
  },
  "catalogue.button": {
    de: "Alle Titel ansehen",
    en: "View All Titles"
  },
  ...
  "items": [
    {
      ...
      desc: {
        de: "Eine Reise in den Norden Kanadas, zu Karibu, Tundra, Flusslandschaften und der letzten großen Weite.",
        en: "A journey into northern Canada: caribou, tundra, river country, and the last great distances."
      }
    },
    {
      author: "Ernest Thompson Seton",
      ext: "png",
      title: { de: "Wahb. Die Geschichte eines Grizzlys", en: "Wahb. The Biography of a Grizzly" },
      desc: {
        de: "Die Lebensgeschichte eines Bären als Schicksalsbild der Wildnis: Geburt, Verlust, Kampf, Herrschaft und Einsamkeit.",
        en: "The life of a bear as a destiny of the wilderness: birth, loss, struggle, dominion, and solitude."
      }
    },
    {
      author: "Ernest Thompson Seton",
    ...
    },
    {
      ...
      desc: {
        de: "Setons klassischer Zugang zur Tierbiographie: Tiere nicht als Typen, sondern als unverwechselbare Gestalten.",
        en: "Seton’s classic approach to animal biography: animals not as types, but as distinct and unforgettable beings."
      }
    },
    {
      author: "Ernest Thompson Seton",
      title: { de: "Rolf in den Wäldern", en: "Rolf in the Woods" },
      desc: {
        de: "Abenteuer, Waldwissen und Charakterbildung in der Grenzwelt Nordamerikas.",
        en: "Adventure, woodcraft, and character formation in the North American frontier world."
      }
    },
    {
      author: "Ernest Thompson Seton",
      ...
      desc: {
        de: "Ein Buch über Jugend, Naturkunde, Spiel, Ernst und das Lernen im Angesicht der Wildnis.",
        en: "A book about youth, nature knowledge, play, seriousness, and learning in the presence of the wilderness."
      }
    }
  ],
  ...
  "pillarsItems": [
    {
      num: "I",
      title: { de: "Quellentreue", en: "Fidelity to the Source" },
      desc: {
        de: "Der ursprüngliche Gedanke des Werkes bleibt maßgeblich. Keine Umdeutung, keine künstliche Aktualisierung, keine moralische Überformung.",
        en: "The original thought of the work remains decisive. No reinterpretation, no artificial updating, no moral overpainting."
      }
    },
    {
      num: "II",
    ...
    {
      num: "III",
      title: { de: "Syntaxmodernisierung", en: "Syntactic Modernization" },
      desc: {
        de: "Schwere, lange oder altertümliche Satzgefüge werden behutsam geordnet. Die Struktur wird geklärt, aber der Ton bleibt würdig. Verständlichkeit bedeutet nicht Verflachung.",
        en: "Difficult, long, or archaic sentence structures are carefully ordered. The structure is clarified, but the tone remains dignified. Clarity does not mean flattening."
      }
    },
    {
      num: "IV",
  ...
  // Column Titles
  "footer.colSeries": { de: "Reihen", en: "Series" },
  "footer.colHouse": { de: "Verlag", en: "House" },
  "footer.colReader": { de: "Leser", en: "Reader" },

  // Links for Series
  "footer.linkAnthracite": { de: "Anthrazit", en: "Anthracite" },
  "footer.linkGreen": { de: "Grün", en: "Green" },
  ...
  "footer.linkMission": { de: "Leitbild", en: "Mission" },
  "footer.linkTranslation": { de: "Übersetzung", en: "Translation" },
  "footer.linkPress": { de: "Presse", en: "Press" },
  ...
  // Copyright Line
  "footer.copyright": { de: "© AETERNUS VERLAG. Alle Rechte vorbehalten.", en: "© AETERNUS VERLAG. All rights reserved." },
  ...
  "catalogItems": [
    {
      ...
      "hover_bg": "#2a1f1f",
      "accent_color": "#ff4a4a",
      "label": { de: "Säule I", en: "Pillar I" },
      "category": { de: "ANTHRAZIT", en: "ANTHRACITE" },
      "title": { de: "Krieg, Strategie und Grenzräume", en: "War, Strategy, and Frontier Regions" },
    ...
    },
    {
      ...
      "hover_bg": "#222f26",
      "accent_color": "#2d4a22",
      "label": { de: "Säule II", en: "Pillar II" },
      "category": { de: "GRÜN", en: "GREEN" },
      "title": { de: "Natur, Wildnis und Tierwelt", en: "Nature, Wilderness, and Animal Life" },
    ...
    },
     {
      ...
      "accent_color": "#ff4a4a",
      "label": { de: "Säule I", en: "Pillar I" },
      "category": { de: "ROT", en: "RED" },
      "title": { de: "Wirtschaft, Industrie und Aufstieg", en: "Economy, Industry, and Ascent" },
      "alt_text": "Cannae, 216 v. Chr. — gebundene Erstausgabe"
    },
     {
      ...
      "accent_color": "#ff4a4a",
      "label": { de: "Säule I", en: "Pillar I" },
      "category": { de: "BLAU", en: "BLUE" },
        "title": { de: "Staatskunst, Geschichte und Diplomatie", en: "Statecraft, History, and Diplomacy" },
      "alt_text": "Cannae, 216 v. Chr. — gebundene Erstausgabe"
    },
     {
      ...
      "accent_color": "#ff4a4a",
      "label": { de: "Säule I", en: "Pillar I" },
      "category": { de: "BERNSTEIN", en: "AMBER" },
      "title": { de: "Jugend, Abenteuer und Charakterbildung", en: "Youth, Adventure, and Character Formation" },
      "alt_text": "Cannae, 216 v. Chr. — gebundene Erstausgabe"
    },
  ]
};
